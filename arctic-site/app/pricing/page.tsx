          ...
          {[
            {
              ...
              price: 'Free',
              period: 'Forever',
              desc: 'For individual developers and research.',
              highlighted: false,
              features: [
                { text: 'Up to 10GB vault storage', included: true },
                { text: '1,000 API calls/month', included: true },
                { text: 'Local-first deployment', included: true },
            ...
            },
            {
              ...
              highlighted: true,
              features: [
                { text: 'Up to 500GB vault storage', included: true },
        ...
        <div className="space-y-4">
          {[
            ...
            },
            {
              ...
              a: 'Professional and Enterprise plans have unlimited API calls. Community plan alerts at 80%.',
            },
            {
            ...
            {
              q: 'Can I self-host?',
              a: 'Yes. Enterprise plan includes self-hosted deployment option with dedicated support.',
            },
          ].map((item, i) => (
            <motion.details
              key={i}
